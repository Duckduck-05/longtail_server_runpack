...
def get_fid_acts(images, num_images=None,
                 batch_size=50,
                 parallel=False, use_torch=False, verbose=False):
    print('start generating fid acts')
...
def get_inception_and_fid_score(images, labels, fid_cache, feats_cache, num_images=None,
    ...
    print('fid', fid_score)
    print('is', is_score)
    print('prd_score (f_beta, f_beta_inv)', prd_score)
